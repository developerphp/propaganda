...
<script>
    ...
    function projectadd()
    {
        $.fn.modal({
            ...
            height:     "100px",
            layout:     "elastic",
            url:        "<?php echo base_url() ?>busycms/customeradd/",
            padding:    "50px"
            //animation:  "flipInX"
        });
    }
    ...
    {
        $.ajax({
        url: '<?php echo base_url() ?>busycms/customerdelete/'+id,
    ...
    function deletecustomer(id) {
        ...
        txt='<br/>Delete is customer <br/><br/><a style="color:#000;" href="javascript:void(0)" onclick="deletedo('+id+')">Yes</a> or \n\
...
<body>
    ...
    <!--                        <input type="text" name="search" class="search_user" />-->
                            &nbsp;
                            <button onclick="projectadd()">Add Customer</button>                            
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                               ...
                               <li id="customer_<?php echo $project->id ?>" class="<?php if ($project->publish==1) { echo "publish"; } else { echo "unpublish"; } ?>">
                                   ...
                                   <div class="project_menu">
                                       <div>
                                           ...
                                           <a href="<?php echo base_url() ?>busycms/customeredit/<?php echo $project->id ?>">8</a>
                                           <a href="javascript:void(0)" onclick="deletecustomer(<?php echo $project->id ?>)">X</a>                                           
                                       </div>
                                   </div>
                               </li> 
                               <?php }?>
