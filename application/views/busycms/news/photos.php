...
<div id="artistimagelist">
    <ul class="images">
        <?php 
            $sql=$this->db->query("select * from news_images where news_id=".$news->id." order by reorder asc");
...
<!--                    <a href="javascript:void(0)" onclick="edit(<?php echo $image->id ?>)"><span>8</span>Edit Image</a><br/>-->
        ...
        <li id="addartistimage">
            <img src="<?php echo base_url() ?>busycms/images/add-photo.png" onclick="$('#uploadnewsimageinput').click();" />
        </li>
    </ul>
    <div style="width:1px;height:1px;overflow:hidden;">
    <form method="post" id="uploadnewsimage" name="uploadnewsimage" action="<?php echo base_url() ?>busycms/uploadimagenews/<?php echo $news->id ?>" enctype="multipart/form-data" target="ajax3">
        <input id="uploadnewsimageinput" name="images[]" type="file" min="1" max="30" multiple="multiple"  onchange="$('#uploadnewsimage').submit();" /><br/><br/>
