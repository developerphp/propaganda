        ...
        <div class="scroll con">
            <div class="section" title="User Interface" id="ui" style="display: block;padding-bottom:1px;">
                <div class="uploadform">
                            <form method="post" action="<?php echo base_url() ?>busycms/uploadimageevent/<?php echo $p->id ?>" enctype="multipart/form-data" target="ajax">
                ...
                <div class="imageslist">
                    <div id="imagelist">
                        <ul class="images">
                            <?php 
                            $sql=$this->db->query("select * from images where pageid=".$p->id." and nedir=2 order by reorder asc");
                            ...
                            <li id="recordsArray_<?php echo $image->id ?>">
                                ...
                                <div class="menus">
                                    ...
                                    <a href="<?php echo base_url() ?>busycms/mainimageevent/<?php echo $p->id ?>/<?php echo $image->id ?>">Main Image</a><br/>
                                    <a href="<?php echo base_url() ?>busycms/cropimageevent/<?php echo $p->id ?>/<?php echo $image->id ?>">Crop Image</a><br/>
