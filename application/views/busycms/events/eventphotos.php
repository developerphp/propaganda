...
<div id="artistimagelist">
    <ul class="images">
        <?php 
            $sql=$this->db->query("select * from images where pageid=".$artist->id." and nedir=2 order by reorder asc");
        ...
        <li id="addartistimage">
            <img src="<?php echo base_url() ?>busycms/images/add-photo.png" onclick="$('#uploadeventimageinput').click();" />
        </li>
    </ul>
    <div style="width:1px;height:1px;overflow:hidden;">
    <form method="post" id="uploadeventimage" name="uploadeventimage" action="<?php echo base_url() ?>busycms/uploadimageevent/<?php echo $artist->id ?>" enctype="multipart/form-data" target="ajax3">
        <input id="uploadeventimageinput" name="images[]" type="file" min="1" max="30" multiple="multiple"  onchange="$('#uploadeventimage').submit();" /><br/><br/>
